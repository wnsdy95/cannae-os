...
| Protected gateway transaction and recovery | `docs/protected-tool-gateway-contract.md`, `docs/repository-artifact-isolation-policy.md` | `protected-tool-gateway.js`, `scripts/operate_protected_gateway.js`, `run-protected-tool-gateway-fixtures.js` |
