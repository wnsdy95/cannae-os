...
| Protected gateway transaction, authenticated identity, and recovery | `docs/protected-tool-gateway-contract.md`, `docs/gateway-identity-admission.md`, `docs/repository-artifact-isolation-policy.md` | `protected-tool-gateway.js`, `gateway-identity-adapter.js`, `scripts/operate_protected_gateway.js`, `scripts/operate_gateway_identity.js`, gateway fixture runners |
