...
The common adapter verifies a policy-pinned builder assertion. It does not yet verify native GitHub or GitLab OIDC tokens, independently attest a local host, or appraise TEE vendor evidence. See `docs/verifier-execution-integrity.md` for provider boundaries.
